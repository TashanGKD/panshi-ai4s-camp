...
describe('API runtime configuration', () => {
  it('validates the API port and normalizes comma-separated allowed origins', () => {
    expect(getApiEnv({
      ...
      TRUST_PROXY_HOPS: 0,
      RATE_LIMIT_STORE_MAX_BUCKETS: 50_000,
      RATE_LIMIT_STORE_SWEEP_INTERVAL_MS: 60_000,
      RATE_LIMIT_LOGIN_FAILURE_MAX: 5,
      RATE_LIMIT_LOGIN_FAILURE_WINDOW_MS: 900_000,
      ...
      RATE_LIMIT_AUTHENTICATED_WINDOW_MS: 60_000,
      ...
      BACKUP_ROOT: expect.stringMatching(/\/panshi-ai4s-camp\/var\/backups$/u),
  ...
  it.each([
    ...
    { NODE_ENV: 'test', APP_VERSION: '../../secret' },
