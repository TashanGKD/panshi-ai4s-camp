...
const contentLinks = [
  ...
  ['/content/importantDates', '重要日期'], ['/content/schedule', '实训日程与师资'], ['/content/travel', '交通住宿'],
