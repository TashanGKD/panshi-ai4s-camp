...
export const learnerCapabilities = CapabilityRegistrySchema.parse([
  ...
  defineCapability('auth.verification.send', 'POST /api/v1/auth/verification/send', ['/register', '/forgot-password'], 'auth verification send', ['auth.verification.send'], ['anonymous'], 'write', 'single', 'VerificationSendResponse'),
  ...
  defineCapability('auth.login', 'POST /api/v1/auth/login', ['/login'], 'auth login', ['auth.login'], ['anonymous'], 'write', 'single', 'AuthResponse'),
  ...
  defineCapability('auth.password_reset', 'POST /api/v1/auth/password/reset', ['/forgot-password'], 'auth password reset', ['auth.password_reset'], ['anonymous'], 'write', 'single', 'PasswordResetResponse'),
