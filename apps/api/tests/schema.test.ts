...
const expectedPrimaryKeys = [
  ...
  { tableName: 'check_in_credentials', constraintName: 'check_in_credentials_pkey', columns: ['id'] },
  { tableName: 'check_ins', constraintName: 'check_ins_pkey', columns: ['id'] },
  { tableName: 'confirmation_intents', constraintName: 'confirmation_intents_pkey', columns: ['id'] },
  ...
  { tableName: 'file_storage_recoveries', constraintName: 'file_storage_recoveries_pkey', columns: ['id'] },
...
const expectedUniqueConstraints = [
  ...
  { tableName: 'check_in_credentials', constraintName: 'check_in_credentials_application_id_unique', columns: ['application_id'] },
  { tableName: 'check_in_credentials', constraintName: 'check_in_credentials_public_id_unique', columns: ['public_id'] },
  { tableName: 'check_ins', constraintName: 'check_ins_application_id_unique', columns: ['application_id'] },
  { tableName: 'check_ins', constraintName: 'check_ins_credential_id_unique', columns: ['credential_id'] },
  ...
  { tableName: 'file_storage_recoveries', constraintName: 'file_storage_recoveries_storage_key_unique', columns: ['storage_key'] },
...
const expectedForeignKeys = [
  ...
  { tableName: 'check_in_credentials', constraintName: 'check_in_credentials_application_id_applications_id_fk', columns: ['application_id'], referencedTableName: 'applications', referencedColumns: ['id'], deleteAction: 'cascade' },
  { tableName: 'check_ins', constraintName: 'check_ins_application_id_applications_id_fk', columns: ['application_id'], referencedTableName: 'applications', referencedColumns: ['id'], deleteAction: 'cascade' },
  { tableName: 'check_ins', constraintName: 'check_ins_confirmed_by_users_id_fk', columns: ['confirmed_by'], referencedTableName: 'users', referencedColumns: ['id'], deleteAction: 'restrict' },
  { tableName: 'check_ins', constraintName: 'check_ins_credential_id_check_in_credentials_id_fk', columns: ['credential_id'], referencedTableName: 'check_in_credentials', referencedColumns: ['id'], deleteAction: 'cascade' },
  { tableName: 'check_ins', constraintName: 'check_ins_revoked_by_users_id_fk', columns: ['revoked_by'], referencedTableName: 'users', referencedColumns: ['id'], deleteAction: 'restrict' },
  { tableName: 'confirmation_intents', constraintName: 'confirmation_intents_actor_user_id_fkey', columns: ['actor_user_id'], referencedTableName: 'users', referencedColumns: ['id'], deleteAction: 'restrict' },
  ...
  { tableName: 'file_storage_recoveries', constraintName: 'file_storage_recoveries_actor_user_id_fkey', columns: ['actor_user_id'], referencedTableName: 'users', referencedColumns: ['id'], deleteAction: 'restrict' },
...
const expectedChecks = [
  ...
  { constraintName: 'check_in_credentials_revision_check', tokens: ['revision', '>= 0'] },
  { constraintName: 'check_ins_active_state_check', tokens: ['active', 'confirmed_at', 'confirmed_by'] },
  { constraintName: 'check_ins_revision_check', tokens: ['revision', '>= 0'] },
  { constraintName: 'check_ins_revocation_state_check', tokens: ['revoked_at', 'revoked_by', 'revoke_reason', 'btrim'] },
  { constraintName: 'confirmation_intents_client_binding_check', tokens: ['client_binding_digest', 'a-f0-9', '64'] },
  { constraintName: 'confirmation_intents_consumed_state_check', tokens: ['status', 'consumed', 'consumed_at', 'safe_result'] },
  { constraintName: 'confirmation_intents_payload_sha256_check', tokens: ['payload_sha256', 'a-f0-9', '64'] },
  { constraintName: 'confirmation_intents_revision_check', tokens: ['expected_revision', '>= 0'] },
  { constraintName: 'confirmation_intents_site_id_check', tokens: ['site_id', 'panshi-ai4s-camp'] },
  { constraintName: 'confirmation_intents_status_check', tokens: ['status', 'pending', 'executing', 'consumed', 'expired', 'failed'] },
  ...
  { constraintName: 'file_storage_recoveries_state_check', tokens: ['state', 'pending', 'delete_failed'] },
  { constraintName: 'files_attachment_slot_check', tokens: ['attachment_slot', 'NULL'] },
  { constraintName: 'files_delete_failure_state_check', tokens: ['lifecycle_state', 'delete_failed', 'delete_failure_code', 'NULL'] },
  { constraintName: 'files_deleted_state_check', tokens: ['lifecycle_state', 'deleted', 'deleted_at', 'NULL'] },
  { constraintName: 'files_lifecycle_state_check', tokens: ['lifecycle_state', 'active', 'deleting', 'delete_failed', 'deleted'] },
