...
所需 CLI 版本：`0.1.6`。公开安装 Skill 使用 `npx --yes skills@latest add TashanGKD/panshi-ai4s-camp --global --agent codex claude-code --skill panshi-camp --yes`。需要 Node.js 24 与 npm 11；无需克隆源码、无需 sudo。Skill 安装完成不代表已同意安装 CLI。
