...
if (process.env.VISUAL_E2E !== '1' || databaseUrl !== exactDatabaseUrl) {
  throw new Error(`Visual tests require VISUAL_E2E=1 and TEST_DATABASE_URL=${exactDatabaseUrl}`)
}
  ...
  webServer: [
    {
      ...
      env: {
        API_PORT: '3002', DATABASE_URL: databaseUrl, VISUAL_E2E: '1', NODE_ENV: 'test',
        JSON_BODY_LIMIT: '1mb', HEALTHCHECK_TIMEOUT_MS: '2000', SESSION_TTL_SECONDS: '28800',
